...
class DP_General_Settings extends DP_Panel {
	...
	function add_menu_pages(){
		$this->page_hook = add_menu_page(__('DeXXX Options', 'dp'), __('DeXXX Options', 'dp'), 'edit_theme_options', $this->menu_slug, array(&$this, 'menu_page'), '', 61);
		add_submenu_page('theme-options', __('DeXXX Settings', 'dp'), __('DeXXX General', 'dp'), 'edit_theme_options', $this->menu_slug, array(&$this, 'menu_page'));
	}
		...
		$fields = array(
			...
			'dp-footer-settings' => array(
				...
				array(
					...
					'value' => __('Powered by <a target="_blank" href="http://www.wpadultthemes.xyz" title="wp adult themes" target="_blank">Wp Adult Themes</a> & <a target="_blank" href="http://befuck.wpadultthemes.xyz" title="Befuck" target="_blank" rel="dofollow">Befuck</a> All Right Reserved.', 'dp'),
					'desc' => __('To prevent the entry of minors, this site has been labeled by RTA Adult (Restricted To Adults, restricted to adults, in English). You can easily block access to this site by a filter navigation. ', 'dp')
				),
				array(
					'type' => 'checkbox',
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'prepend' => __('URL:', 'dp'),
							'value' => 'https://twitter.com/wpadulttheme',
							'class' => 'regular-text'
						),
						array(
							'type' => 'text',
