...
abstract class DP_Panel {
	...
	function __construct() {
		...
		$this->donate_url = !empty($this->donate_url) ? $this->donate_url : 'http://';
		$this->support_url = !empty($this->support_url) ? $this->support_url : 'http://www.wpadultthemes.xyz';
		$this->translating_url = !empty($this->translating_url) ? $this->translating_url : 'http://www.wpadultthemes.xyz';
	...
	function screen_icon() {
		echo '<a target="_blank" href="http://wpadultthemes.xyz">' . get_screen_icon('themes') . '</a>';
	}
